...
jint lua_doString_(JNIEnv *env, jclass clazz, jlong ptr, jstring str);
...
jint lua_tostring_(JNIEnv *env, jclass clazz, jlong ptr, int i);
...
void lua_getglobal_(JNIEnv *env, jclass clazz, jlong ptr, jstring name);
