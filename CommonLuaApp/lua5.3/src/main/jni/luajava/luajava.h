...
jint jni_compare  (JNIEnv * env , jobject jobj , jobject cptr , jint idx1 , jint idx2, jint op);
...
jint jni_rawlen  (JNIEnv * env , jobject jobj , jobject cptr , jint idx);
...
static JNINativeMethod jni_methods[] = {
		...
		{"_compare",               "(" CPTR_CLASS_PATH "III)I",                                                                       (void *) jni_compare},
...
//		{"_strlen", "(" CPTR_CLASS_PATH "I)I", (void*)jni_strlen},
		{"_rawlen",                "(" CPTR_CLASS_PATH "I)I",                                                                         (void *) jni_rawlen},
