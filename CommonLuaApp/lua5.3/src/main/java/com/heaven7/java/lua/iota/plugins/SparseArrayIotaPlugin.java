package com.heaven7.java.lua.iota.plugins;

import com.heaven7.java.base.util.SparseArrayDelegate;
import com.heaven7.java.base.util.SparseFactory;
import com.heaven7.java.lua.LuaTypeAdapter;
import com.heaven7.java.lua.iota.BasicTypeAdapterProvider;
import com.heaven7.java.lua.iota.MapIotaPlugin;
 ...
 * @author heaven7
 */
public final class SparseArrayIotaPlugin extends MapIotaPlugin {
    ...
    public Map<?, ?> create(Object obj) {
        return new SparseArrayMap((SparseArrayDelegate) obj);
    }
    @Override
    public Map<?, ?> create(Class<?> clazz) {
        return new SparseArrayMap<>(SparseFactory.newSparseArray(10));
    }
    @Override
    public LuaTypeAdapter getKeyAdapter(BasicTypeAdapterProvider provider, Class<?> type) {
        return provider.getBasicTypeAdapter(int.class);
    }
    @Override
    public LuaTypeAdapter getValueAdapter(BasicTypeAdapterProvider provider, Class<?> type) {
        //SparseArray. map is not fixed. so here do nothing
        return null;
    }
